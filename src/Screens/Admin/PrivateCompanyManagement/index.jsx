...
const PrivateCompanyManagement = ({
  showModal,
  closeModal,
  filters,
  setFilters,
    ...
    <>
      <section className="head-coach-management">
        <div className="admin-content-header mb-4 d-flex justify-content-between align-items-center gap-2">
          <h2 className="screen-title mb-0">Private Company Management</h2>
          <Link
...
export default withModal(withFilters(PrivateCompanyManagement));
