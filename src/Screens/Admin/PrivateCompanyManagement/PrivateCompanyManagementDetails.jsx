...
import {
  ...
  viewPalletLogs,
  incidentLogs,
} from '../../../Services/Admin/PrivateCompanyManagement';
...
const privateCompanyManagementDetails = ({
  showModal,
  filters,
  setFilters,
  pagination,
  ...
  usePageTitle('Private Company Profile details');
  ...
  return (
    <section className="Private Company Profile details">
      <div className="admin-content-header mb-4 d-flex gap-2">
        <BackButton />
        <h2 className="page-title">Private Company Profile details</h2>
      </div>
        ...
        <Row>
          <Col xs={12}>
            <CustomTable
              ...
              headers={palletPrivateLogsHeaders}
...
export default withFilters(withModal(privateCompanyManagementDetails));
