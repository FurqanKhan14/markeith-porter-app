...
import {
  ...
  viewPalletLogs,
  incidentLogs,
} from '../../../Services/Admin/ShipyardUserManagement';
...
const ShipyardUserManagementDetails = ({
  showModal,
  filters,
  setFilters,
  pagination,
  ...
  return (
    <section className="Private Company Profile details">
      <div className="admin-content-header mb-4 d-flex gap-2">
        <BackButton />
        <h2 className="page-title">Shipyard User Profile details</h2>
      </div>
...
export default withFilters(withModal(ShipyardUserManagementDetails));
