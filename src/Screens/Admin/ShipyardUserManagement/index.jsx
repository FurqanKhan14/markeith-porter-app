...
import { getLoaderListing } from '../../../Services/Admin/ShipyardUserManagement';
import {
  userStatus,
  userStatusFilters,
    ...
    <>
      <section className="head-coach-management">
        <div className="admin-content-header mb-4 d-flex justify-content-between align-items-center gap-2">
          <h2 className="screen-title mb-0">Shipyard User Management</h2>
          <Link
            className="btn btn-link-profile text-capitalize"
            to="/admin/shipyard-user-management/add"
          >
            Add new Shipyard user
          </Link>
        </div>
...
export default withModal(withFilters(ShipyardUserManagement));
